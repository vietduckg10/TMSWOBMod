...
public class TMSWOBEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event){
        addEntityToSpecificBiomes(event, TMSWOBEntityTypes.BEAN.get(), 10, 1, 2,
                Biomes.PLAINS, Biomes.JUNGLE, Biomes.FOREST, Biomes.TAIGA);
    }
