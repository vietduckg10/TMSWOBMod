...
@Mod(TMSWOBMod.MODID)
public class TMSWOBMod {
    // Directly reference a log4j logger.
    private static final Logger LOGGER = LogManager.getLogger();
    public static final String MODID = "tmswob";
    ...
    public TMSWOBMod() {
        ...
        TMSWOBItems.init(eventBus);
        TMSWOBBlocks.init(eventBus);
        TMSWOBEntityTypes.init(eventBus);
    }
    ...
    private void enqueueIMC(final InterModEnqueueEvent event)
    {
        ...
        InterModComms.sendTo(TMSWOBMod.MODID, "helloworld", () -> { LOGGER.info("Hello world from the MDK"); return "Hello world";});
    }
