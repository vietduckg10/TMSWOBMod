...
public class TMSWOBSpawnEggItem extends SpawnEggItem {
    protected static final List<TMSWOBSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public TMSWOBSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
